...
const PINNED_REPOS = ["Web-Aonime", "anikoto-scrap"];
...
function ForkIcon() {
  return (
    <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M7 5C7 3.9 7.9 3 9 3s2 .9 2 2-.9 2-2 2-2-.9-2-2zm10 0c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2zM9 7.5v2.1A5.002 5.002 0 0 1 12 14.5a5.002 5.002 0 0 1 3-4.9V7.5a4 4 0 1 0-6 0zM12 16.5c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/>
    </svg>
  );
}
